...
def data_get():
    city=city_name.get()
    data = requests.get("https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=7c83c219930d33bd06c0fefeb2da8fe0").json()
...
com=ttk.Combobox(win,text="select state name",values=list_name,
...
temp_label=Label(win,text="Temprature", font=("Time New Roman",15))
temp_label.place(x=25,y=400,height=50,width=210) 
temp_label1=Label(win,text="", font=("Time New Roman",15))
temp_label1.place(x=250,y=400,height=50,width=210) 

pressure_label=Label(win,text="Pressure", font=("Time New Roman",15))
pressure_label.place(x=25,y=470,height=50,width=210) 
pressure_label1=Label(win,text="", font=("Time New Roman",15))
pressure_label1.place(x=250,y=470,height=50,width=210) 


done_button = Button(win,text="Done",
                               font=("Times New Roman",25,"bold",),command=data_get)
done_button.place(y=200,height=50,width=100,x=200)
